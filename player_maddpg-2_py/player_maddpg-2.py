...
##############################################################################
        def init_variables(self, info):
            ...
            self.action_n = [np.zeros(self.action_dim) for _ in range(self.number_of_robots)]
...
##############################################################################
    ...
    def setup_summary(self):
        ...
        summary_vars = [episode_total_reward, episode_0_reward, episode_1_reward, 
            episode_2_reward, episode_3_reward, episode_4_reward]
...
##############################################################################    
    ...
    def pre_processing(self, i):
        ...
        return np.concatenate([relative_ball] + [relative_goal] + relative_my_team + relative_op_team + [[self.cur_my_posture[i][TH]]])
...
##############################################################################
            ...
            if done: # plot the statics
                ...
                stats = [sum(self.reward_sum)] + [self.reward_sum[i] for i in range(len(self.reward_sum))]
