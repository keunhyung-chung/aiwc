...
class DDPGAgent:
    ...
    def build_critic_network(self):
        ...
        s0 = Dense(32, activation='relu')(input_state)
        s1 = Dense(32, activation='linear')(s0)
        a0 = Dense(32, activation='linear')(input_action)
        c0 = Concatenate()([s1, a0])
        c1 = Dense(32, activation='relu')(c0)
    ...
    def build_actor_network(self):
        input_state = Input(shape=[self.state_size*self.history_size])
        a0 = Dense(128, activation='relu')(input_state)
        a1 = Dense(128, activation='relu')(a0)
        a2 = Dense(32, activation='relu')(a1)
        action = Dense(self.action_size,activation='tanh')(a2)
    ...
    def get_action(self, history):
        ...
        self.printConsole("noise: " + str(noise[:2]))
